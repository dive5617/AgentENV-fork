...
// statTimes contains the platform-neutral fields extracted from syscall.Stat_t.
...
// GetEntryInfo converts os.FileInfo into the filesystem API's portable entry model.
